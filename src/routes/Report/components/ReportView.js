...
const measures = [
  ...
  },
  {
    ...
    info: 'The  the Total Excessive Delay for all vehicles traveling through each' +
      ...
      <div className='container-fluid homeBody' style={{ width: '100%' }}>
        <div className='container homeContent' style={{ zIndex:5 }}>
          <section className='section' style={{ paddingTop: 30 }}>
            <Link to='/' >Back</Link>
            <h1 style={{ marginTop: 0, marginBottom: 5 }}>{StatesHash[this.props.params.stateId.toUpperCase()]} {GeoNames[this.props.params.geoType]}</h1>
            <div className='row'>
